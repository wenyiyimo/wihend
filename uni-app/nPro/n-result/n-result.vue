...
<script>
	 ...
	 * @property {String} descType = [nav-title|nav-icon|nav-item|primary|success|warning|error|inverse|custom|link|text|second|third|forth|place|disabled] 描述颜色主题
	 * @property {String} descSize = [ss|s|base|l|ll] 描述尺寸主题
