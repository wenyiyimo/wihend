<template>
	<view :class="['n-picker-box', 'n-flex-column', 'n-bg-'+bgType]" :style="mrBoxStyle">
		<picker-view v-if="mode==='date' || mode==='yearMonth' || mode==='dateTime' || mode=='time'" class="n-flex-1" :indicator-style="mrIndicatorStyle" :value="pickVal" @change="bindChange">
		...
		<picker-view v-if="mode==='dateRange'||mode==='yearMonthRange'" class="n-flex-1" :indicator-style="mrIndicatorStyle" :value="pickVal" @change="bindChange">
			<picker-view-column>
		...
		<picker-view v-if="mode==='timeRange'" class="n-flex-1" :indicator-style="mrIndicatorStyle" :value="pickVal" @change="bindChange">
			<picker-view-column>
