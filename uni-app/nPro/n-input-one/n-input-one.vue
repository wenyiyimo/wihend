<template>
	<view class="n-position-relative n-flex-row n-justify-center" :style="boxStyle">
		...
		<!-- #ifdef APP-NVUE -->
		<input ref="n-input" :disabled="disabled" type="number" :adjust-position="adjust" :value="inputValue" :focus="focus" :maxlength="maxlength" class="n-one-hide-input" :style="{height: width}" @input="getVal" @blur="toBlur" @focus="toFocus" @confirm="toConfirm" @keyboardheightchange="toKbChange" />
		<!-- #endif -->
		<!-- #ifndef APP-NVUE -->
