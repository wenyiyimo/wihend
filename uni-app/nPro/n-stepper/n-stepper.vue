<template>
	<view class="n-flex-row n-align-center n-wrap-nowrap" :style="boxStyle">
		<view :class="['n-stepper-action', 'n-flex-row', 'n-align-center', 'n-justify-center', 'n-bg-'+minusBgType, 'n-radius-'+radius, (disabled||isLess)&&'n-disabled', (disabled||isLess)?'':('n-hover-'+hover+'-n')]" :hover-class="'n-hover-'+hover" :style="mrMinusBoxStyle" bubble="true" @click="minusClicked">
