<template>
	<view :class="['n-flex-column', 'n-align-center', 'n-justify-center', 'n-position-relative', 'n-bg-'+bgType, 'n-border-'+border, 'n-radius-'+radius, 'n-hover-'+hover+'-n']" :hover-class="'n-hover-'+hover" :style="boxStyle" bubble="true" @tap="toSelect">
...
<script>
	 ...
	 * @property {Boolean} isIcon = [true|false] 是否是图标
