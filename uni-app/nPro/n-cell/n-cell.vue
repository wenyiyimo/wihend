<template>
	<view :class="['n-cell', 'n-position-relative', 'n-flex-row', 'n-align-center', 'n-wrap-nowrap', 'n-bg-'+bgType, 'n-height-'+height, 'n-radius-'+radius, 'n-border-'+border, 'n-hover-'+hover+'-n']" :style="boxStyle" :hover-class="'n-hover-'+hover" bubble="true" @tap.stop="toSelect">
		...
		<slot>
			<text :class="['n-text-align-'+valueAlign, 'n-flex-1', 'n-lines-'+valueLines, 'n-color-'+valueType, 'n-size-'+valueSize, 'n-lh-'+valueLh]" :style="valueStyle">{{value}}</text>
		</slot>
