		...
		<slot name="tabs">
			<view class="n-tabs n-flex-column" :style="tabStyle.boxStyle||''">
				<view class="n-tabs-items n-flex-row" :style="tabStyle.tabsStyle||''">
					<view bubble="true" class="n-tabs-item n-flex-column n-flex-1 n-align-center n-justify-between" v-for="(item, idx) in tabs" :key="idx" :ref="'n-tab-'+idx" :style="mrItemStyle" @tap="setPage(idx)">
